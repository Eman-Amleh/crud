...
export default function Create() {
  ...
  <div className="row flex-nowrap">
   ...
   <form  onSubmit={sendData}>
    <Input id={'username'} errors={errors} name={'name'} type={'text'} title={'user name'}   changdata={changdata} />
   
    <Input id={'useremail'} errors={errors} name={'email'} type={'email'} title={'user email'}  changdata={changdata}/>
    
    <Input id={'userpassword'} errors={errors} name={'password'} type={'password'} title={'user password'} changdata={changdata}/>
