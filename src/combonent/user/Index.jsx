  ...
  <tbody>
    {User.length >0?User.map( (ele, index)=>(
          ...
          <tr>
            ...
            <td>{ele.email}</td>
            <td>{ele.password}</td>
            <td className='btn btn-danger' onClick={()=>deleteUser(ele._id)}>Delete</td>
            <td className=' btn btn-danger' > <Link to={`/user/${ele._id}`}>Details</Link></td>
            <td className=' btn btn-danger' > <Link to={`/user/edit/${ele._id}`}>Edit</Link></td>
